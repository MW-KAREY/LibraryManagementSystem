...
Partial Public Class LibraryDBDataSet
    ...
    Partial Public Class BooksDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddBooksRow(ByVal IDENTITY As Integer, ByVal Title As String, ByVal Author As String, ByVal YearPublished As Integer, ByVal Genre As String) As BooksRow
            Dim rowBooksRow As BooksRow = CType(Me.NewRow,BooksRow)
            Dim columnValuesArray() As Object = New Object() {IDENTITY, Title, Author, YearPublished, Genre}
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Function FindByIDENTITY(ByVal IDENTITY As Integer) As BooksRow
            Return CType(Me.Rows.Find(New Object() {IDENTITY}),BooksRow)
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Private Sub InitClass()
            Me.columnIDENTITY = New Global.System.Data.DataColumn("IDENTITY", GetType(Integer), Nothing, Global.System.Data.MappingType.Element)
            ...
            Me.Constraints.Add(New Global.System.Data.UniqueConstraint("Constraint1", New Global.System.Data.DataColumn() {Me.columnIDENTITY}, true))
            Me.columnIDENTITY.AllowDBNull = false
            Me.columnIDENTITY.Unique = true
    ...
    Partial Public Class BooksRow
        ...
        Public Property IDENTITY() As Integer
            Get
                Return CType(Me(Me.tableBooks.IDENTITYColumn),Integer)
            End Get
            Set
                Me(Me.tableBooks.IDENTITYColumn) = value
            End Set
        End Property
...
Namespace LibraryDBDataSetTableAdapters
    ...
    Partial Public Class BooksTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([IDENTITY] = @Original_IDENTITY) AND ((@IsNull_"& _ 
                "Title = 1 AND [Title] IS NULL) OR ([Title] = @Original_Title)) AND ((@IsNull_Aut"& _ 
                "hor = 1 AND [Author] IS NULL) OR ([Author] = @Original_Author)) AND ((@IsNull_Ye"& _ 
                "arPublished = 1 AND [YearPublished] IS NULL) OR ([YearPublished] = @Original_Yea"& _ 
                "rPublished)) AND ((@IsNull_Genre = 1 AND [Genre] IS NULL) OR ([Genre] = @Origina"& _ 
                "l_Genre)))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_IDENTITY", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "IDENTITY", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([IDENTITY], [Title], [Author], [YearPublished], [Genre"& _ 
                "]) VALUES (@IDENTITY, @Title, @Author, @YearPublished, @Genre);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT [IDENTIT"& _ 
                "Y], Title, Author, YearPublished, Genre FROM Books WHERE ([IDENTITY] = @IDENTITY"& _ 
                ")"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IDENTITY", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "IDENTITY", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Books] SET [IDENTITY] = @IDENTITY, [Title] = @Title, [Author] = @Au"& _ 
                "thor, [YearPublished] = @YearPublished, [Genre] = @Genre WHERE (([IDENTITY] = @O"& _ 
                "riginal_IDENTITY) AND ((@IsNull_Title = 1 AND [Title] IS NULL) OR ([Title] = @Or"& _ 
                "iginal_Title)) AND ((@IsNull_Author = 1 AND [Author] IS NULL) OR ([Author] = @Or"& _ 
                "iginal_Author)) AND ((@IsNull_YearPublished = 1 AND [YearPublished] IS NULL) OR "& _ 
                "([YearPublished] = @Original_YearPublished)) AND ((@IsNull_Genre = 1 AND [Genre]"& _ 
                " IS NULL) OR ([Genre] = @Original_Genre)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT [IDENTITY], Title, Author, Y"& _ 
                "earPublished, Genre FROM Books WHERE ([IDENTITY] = @IDENTITY)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@IDENTITY", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "IDENTITY", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@Original_IDENTITY", Global.System.Data.SqlDbType.Int, 0, Global.System.Data.ParameterDirection.Input, 0, 0, "IDENTITY", Global.System.Data.DataRowVersion.Original, false, Nothing, "", "", ""))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Library_Management_System.My.MySettings.Default.LibraryDBConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT [IDENTITY], Title, Author, YearPublished, Genre FROM dbo.Books"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_IDENTITY As Integer, ByVal Original_Title As String, ByVal Original_Author As String, ByVal Original_YearPublished As Global.System.Nullable(Of Integer), ByVal Original_Genre As String) As Integer
            Me.Adapter.DeleteCommand.Parameters(0).Value = CType(Original_IDENTITY,Integer)
        ...
        Public Overloads Overridable Function Insert(ByVal IDENTITY As Integer, ByVal Title As String, ByVal Author As String, ByVal YearPublished As Global.System.Nullable(Of Integer), ByVal Genre As String) As Integer
            Me.Adapter.InsertCommand.Parameters(0).Value = CType(IDENTITY,Integer)
        ...
        Public Overloads Overridable Function Update(ByVal IDENTITY As Integer, ByVal Title As String, ByVal Author As String, ByVal YearPublished As Global.System.Nullable(Of Integer), ByVal Genre As String, ByVal Original_IDENTITY As Integer, ByVal Original_Title As String, ByVal Original_Author As String, ByVal Original_YearPublished As Global.System.Nullable(Of Integer), ByVal Original_Genre As String) As Integer
            Me.Adapter.UpdateCommand.Parameters(0).Value = CType(IDENTITY,Integer)
            If (Title Is Nothing) Then
            ...
            End If
            Me.Adapter.UpdateCommand.Parameters(5).Value = CType(Original_IDENTITY,Integer)
            If (Original_Title Is Nothing) Then
            ...
            If (Original_YearPublished.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(11).Value = CType(Original_YearPublished.Value,Integer)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal Title As String, ByVal Author As String, ByVal YearPublished As Global.System.Nullable(Of Integer), ByVal Genre As String, ByVal Original_IDENTITY As Integer, ByVal Original_Title As String, ByVal Original_Author As String, ByVal Original_YearPublished As Global.System.Nullable(Of Integer), ByVal Original_Genre As String) As Integer
            Return Me.Update(Original_IDENTITY, Title, Author, YearPublished, Genre, Original_IDENTITY, Original_Title, Original_Author, Original_YearPublished, Original_Genre)
        End Function
    End Class
